      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <Link to="/blogs">
            <Button
              size="lg"
              className="bg-gradient-to-r from-green-600 to-indigo-600 hover:from-green-700 hover:to-indigo-700 text-white px-8 py-3 rounded-full transition-all duration-300 hover:shadow-lg hover:scale-105"
            >
              View All Articles
