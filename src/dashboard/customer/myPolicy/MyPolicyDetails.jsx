...
const policyData = {
  ...
  policyDetails: {
    ...
    basePremium: "700",
    imageUrl: "https://i.ibb.co/Q7wtkhFf/scott-graham-OQMZw-Nd3-Th-U-unsplash.jpg",
    category: "senior",
...
export default function MyPolicyDetails() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 p-4 md:p-6 lg:p-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-green-800 mb-2">Insurance Policy Details</h1>
          <p className="text-green-600 text-lg">Application ID: {policyData._id}</p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <Card className="lg:col-span-2 border-green-200 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent className="p-6">
              <p className="text-gray-700 mb-4">{policyData.policyDetails.description}</p>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-3 bg-green-50 rounded-lg">
                  <p className="text-sm text-green-600 font-medium">Category</p>
                  <p className="text-lg font-bold text-green-800 capitalize">{policyData.policyDetails.category}</p>
                </div>
                <div className="text-center p-3 bg-green-50 rounded-lg">
                  <p className="text-sm text-green-600 font-medium">Age Range</p>
                  <p className="text-lg font-bold text-green-800">
                    {policyData.policyDetails.minAge}-{policyData.policyDetails.maximumAge}
                  </p>
                </div>
                <div className="text-center p-3 bg-green-50 rounded-lg">
                  <p className="text-sm text-green-600 font-medium">Base Premium</p>
                  <p className="text-lg font-bold text-green-800">${policyData.policyDetails.basePremium}</p>
                </div>
                <div className="text-center p-3 bg-green-50 rounded-lg">
                  <p className="text-sm text-green-600 font-medium">Coverage</p>
                  <p className="text-lg font-bold text-green-800">
                    ${Number.parseInt(policyData.policyDetails.coverageRange).toLocaleString()}
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="border-green-200 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent className="p-6 text-center">
              <Badge className={`text-lg px-4 py-2 mb-4 ${getStatusColor(policyData.status)}`}>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold text-green-700">
                    {formatCurrency(Number.parseInt(policyData.convertedData.coverageAmount) / 100)}
                  </span>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">{formatDate(policyData.dateOfBirth)}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-semibold capitalize">{policyData.gender}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Marital Status</p>
                  <p className="font-semibold capitalize">{policyData.maritalStatus}</p>
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">{formatCurrency(Number.parseInt(policyData.annualIncome))}</p>
                  </div>
                </div>
              </div>
              <div>
          ...
          <Card className="border-green-200 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                  <p className="text-sm text-gray-600 mb-2">Family Medical History</p>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="font-semibold capitalize">{policyData.smokingStatus}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Alcohol Consumption</p>
                    <p className="font-semibold capitalize">{policyData.alcoholConsumption}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Exercise Frequency</p>
                    <p className="font-semibold capitalize">{policyData.exerciseFrequency}</p>
                  </div>
                </div>
              </div>
            </CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold capitalize">{policyData.relationship}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Date of Birth</p>
                    <p className="font-semibold">{formatDate(policyData.nomineeDateOfBirth)}</p>
                  </div>
                </div>
                <div className="space-y-3">
                  <div>
                  ...
                  <div>
                    <p className="text-sm text-gray-600">Occupation</p>
                    <p className="font-semibold">{policyData.nomineeOccupation}</p>
                  </div>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Address</p>
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="text-center p-4 bg-green-50 rounded-lg border border-green-200">
                  ...
                  <p className="text-2xl font-bold text-green-800">{policyData.convertedData.age}</p>
                </div>
                <div className="text-center p-4 bg-green-50 rounded-lg border border-green-200">
                  <p className="text-sm text-green-600 font-medium mb-2">Duration</p>
                  <p className="text-2xl font-bold text-green-800">{policyData.convertedData.duration}</p>
                </div>
                <div className="text-center p-4 bg-green-50 rounded-lg border border-green-200">
                  <p className="text-sm text-green-600 font-medium mb-2">Coverage Amount</p>
                  <p className="text-xl font-bold text-green-800">
                    {formatCurrency(Number.parseInt(policyData.convertedData.coverageAmount) / 100)}
                  </p>
                </div>
                <div className="text-center p-4 bg-green-50 rounded-lg border border-green-200">
                  <p className="text-sm text-green-600 font-medium mb-2">Smoker Status</p>
                  <p className="text-2xl font-bold text-green-800 capitalize">{policyData.convertedData.smoker}</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <motion.div variants={itemVariants} className="text-center py-6">
          <p className="text-green-600">Application submitted by: {policyData.userEmail}</p>
